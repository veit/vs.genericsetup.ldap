...
setup(name='collective.genericsetup.ldap',
      ...
      author='Anne Walther / Alexander Loechel for IDG (http://www.immanuel.de)/ Veit Schiele (http://www.veit-schiele.de)',
      author_email='awello@gmail.com / Alexander.Loechel@unibw.de',
      maintainer='Anne Walther',
      maintainer_email='awello@gmail.com',
